...
ES2017 标准引入了 async 函数，使得异步操作变得更加方便，即Generator函数的语法糖。
...
上面代码的Generator函数`gen`可以写成`async`函数
...
asyncPrint('hello world', 50);  //指定 50 毫秒以后，输出`hello world`
```
