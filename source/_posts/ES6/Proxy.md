...
---
Proxy是ES6 为了操纵对象提供的代理模式，用于修改某些操作的默认行为。<!-- more -->
<!-- # Proxy -->
## 概述
...
作为构造函数，`Proxy`接受两个参数:第一个参数是所要代理的目标对象，即如果没有`Proxy`的介入，操作原来要访问的就是这个对象；第二个参数是一个配置对象，对于每一个被代理的操作，需要提供一个对应的处理函数，该函数将拦截对应的操作。
...
[https://juejin.cn/post/6844904090116292616](https://juejin.cn/post/6844904090116292616)